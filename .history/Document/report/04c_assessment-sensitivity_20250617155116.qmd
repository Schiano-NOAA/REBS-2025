...
Over the many different sources of potential uncertainty, patterns in how the these sources affect scale and status emerge (@tbl-uncertainty_summary). These sources highlight conflicts in data and selectivity assumptions, while also highlighting key uncertainty in natural mortality. 
