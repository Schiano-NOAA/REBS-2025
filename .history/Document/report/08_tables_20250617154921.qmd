...
#| warning: false
#| echo: false
#| tbl-cap: "Summary of major sources of uncertainty and how they influence the scale and stock status."

Uncertainty_summary <- read.csv(
  here::here("Document/report/tables_4_doc/Uncertainty_summary.csv"),
  header = TRUE
)
