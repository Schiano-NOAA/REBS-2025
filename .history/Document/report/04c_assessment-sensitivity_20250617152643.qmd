...
The component likelihoods show a clear conflict in the length and age data, with lengths pulling for lower $lnR_0$ values and ages for higher $lnR_0$ values (@piner_panel_NatM_uniform_Mal_GP_1). While this is a consistent signal in the ages, the individual length sources also show conflict, with the bottom trawl length data pulling for higher $lnR_0$ values. 
