...
`r spp`  is relatively lightly exploited stock. The maximum annual catch amount over the entire time period of exploitation was 744 metric tons observed in 1995, and the average removals is slightly over 100 metric tons. For comparison, Widow Rockfish catches in recent years have over 12,000 metric tons, and in the early 1980s they were exceeding 28,000 metric tons a year.  

Most likely, catches of `r spp`  were not substantial because `r spp`  is associated with steep slopes and boulder habitats, difficult to access with bottom trawl gears. Plus, it occurs in the northern part of the assessed area (off Oregon and Washington), and is only rarely taken by fisheries in California. Given this relatively light exploitation, the scale of `r spp` is uncertain, as we did not observe large contrasts in the stock dynamics. Such contrasts between periods of depletion, followed by recovery (a.k.a. “two-way trips”) provide more about carrying capacity, the intrinsic growth rate as well as scale of the population.
