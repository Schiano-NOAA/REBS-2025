...
colnames(survey_strata) <- c("Survey", "Stratum Name", "Depth Low", "Depth High", "Latitude Low", "Latitude High")
...
colnames(survey_coverage) <- c("Survey", "Year", "Latitudes Low", "Latitude High", "Depths Low", "Depths High")
...
# ---- TABLE 1 ----
table_1 <- life_history_sens |> dplyr::select(1:7)
...
# ---- TABLE 2 ----
table_2 <- life_history_sens |> dplyr::select(1:3, 8:12)
