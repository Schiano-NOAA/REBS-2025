...
colnames(age_error_sens) <-   c("Label", "Type", "Reference", "No ageing error", "- trawl AE", "- non-trawl AE", "- midwater AE", "- ASHOP AE", "- WCGBTS AE")
...
#| warning: false
#| results: "asis"
#| tbl-cap: "Likelihood values and estimates of key parameters and derived quantities from each life history parameter sensitivity."
#| tbl-pos: H
...
colnames(life_history_sens) <-   c("Label", "Type", "Reference", "Est female M", "Fixed_M_2013", "Lorenzen M", "Fixed growth ext", "Prop fecund", "Fxn mat age", "Fxn mat Bspot", "Fxn mat Reye", "Biological mat")
