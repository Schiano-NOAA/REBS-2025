...
## Model Results 
As a supplement to the model results figures included in this report and described below, a full set of diagnostic plots created by the {r4ss} package [@taylor_beyond_2021] is available at https://github.com/shcaba/REBS-2025 along with the Stock Synthesis input files.
