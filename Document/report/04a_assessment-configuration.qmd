...
- Provided flexibility to bottom trawl and non-trawl fleets to allow for dome-shaped selectivity (@fig-sel-tv-comp) and also to WCGBTS, previously assumed asymptotic. This change was prompted by the lack of fit to length compositions data. Also, the examination of mean fish lengths indicated that bottom trawl fleet and of fish caught in different dfleets illustrated that with selelctivity assumed asymptotic. This change resulted in the increase of stock scale. 
