...
### Model Structure
This stock assessment is for the `r Spp_short`, two species that form one management complex. Assessment area is from the U.S.-Mexican border om the south to the U.S. Canadian border on the north (@fig-map). The assessment excludes consideration of the Puget Sound and Salish Sea. Within this area, the assessment treats the U.S. `r Spp_short` resource as a single coastwide stock. 
...
We also split trawl fishery data into bottom trawl and mid-water trawl fleets. Catch data indicates that contribution of mid-water trawl catches gradually grew over the past 20 years, and now they represent majority of the trawl removals (@fig-landings). Historical information on mid-water catches of `r Spp_short` comes from @pikitch_evaluation_1988, which has no records of `r Spp_short` mid-water trawl catches, neither retained nor discarded. Also, Oregon historical catch reconstruction [@karnowski_historical_2014] has only one record of 0.0002 metric tons of `r Spp_short` taken in 1985, even though the mid-water trawl catches had their own market category in Oregon since the early-1980s [@karnowski_historical_2014], and multiple rockfish species are reported as caught by this gear. This information suggest that historically `r Spp_short` mid-water catches were negligible.
