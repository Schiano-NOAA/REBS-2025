...
The profile on the assumption of \(lnR_0\), which sets the initial scale
...
likelihood difference as \(lnR_0\) goes lower. The is the expectant
increase in scale across increasing \(lnR_0\) values for both initial
and ending spawning output. The final spawning output goes down quicker
than the initial spawning output, leading to a lower stock status.
